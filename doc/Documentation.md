...
<a name="висновок"> </a>
# Висновок 
**Проект "VT+"** — проект, що поєднує просте та зручне орієнтування з приємним дизайном, та великою інформативнітю сторінок. Реалізованний на базі технологій HTML, CSS, JavaScript та PHP.
